        ...
        private static bool RequiresInstanceStorage(ref object value) 
        {
            ...
            if ((deferredReference = value as DeferredReference) != null)
            {
                ...
                if (valueType != null) 
                {
                    ...
                    { 
                        markupExtension = (MarkupExtension)deferredReference.GetValue(BaseValueSourceInternal.Style);
                    } 
...
*/
        ...
        { 
            ...
            Debug.Assert(value != null, "attempt to retrieve instance value that was never set");
            if (value == null)
                value = NotYetApplied;
