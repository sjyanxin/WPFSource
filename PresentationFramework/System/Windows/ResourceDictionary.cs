    ...
    { 
        ...
        { 
            ...
            { 
                canCache = false;
                value = null; 
                return false; /* Not defered content */ 
            }
            ...
            if (key != null) 
            {
                ...
                return true; /* yes deferred content */
            } 
            else 
            {
                canCache = true; 
        ...
        internal object Lookup(object key, bool allowDeferredResourceReference, bool mustReturnDeferredResourceReference)
        { 
            if (allowDeferredResourceReference) 
            {
                // Attempt to delay load resources from ResourceDictionaries 
                bool canCache;
                return FetchResource(key, allowDeferredResourceReference, mustReturnDeferredResourceReference, out canCache);
            }
            else 
            {
