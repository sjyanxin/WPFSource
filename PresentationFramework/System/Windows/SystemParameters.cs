            ...
            get
            {
                ...
                { 
                    ...
                    { 
                        ...
                        _workArea = new Rect(ConvertPixel(workArea.left), ConvertPixel(workArea.top), ConvertPixel(workArea.right - workArea.left + 1), ConvertPixel(workArea.bottom - workArea.top + 1)); 
        ...
        { 
            ...
            { 
                ...
                case NativeMethods.SPI_SETFOCUSBORDERHEIGHT: 
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.FocusBorderHeight);
                case NativeMethods.SPI_SETHIGHCONTRAST:
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.HighContrast);
                case NativeMethods.SPI_SETMOUSEVANISH: 
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.MouseVanish);
 
                case NativeMethods.SPI_SETDROPSHADOW: 
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.DropShadow);
                case NativeMethods.SPI_SETFLATMENU: 
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.FlatMenu);
                ...
                case NativeMethods.SPI_SETKEYBOARDCUES: 
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.KeyboardCues);
                case NativeMethods.SPI_SETKEYBOARDDELAY:
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.KeyboardDelay);
                case NativeMethods.SPI_SETKEYBOARDPREF: 
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.KeyboardPreference);
                case NativeMethods.SPI_SETKEYBOARDSPEED: 
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.KeyboardSpeed); 
                case NativeMethods.SPI_SETSNAPTODEFBUTTON:
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.SnapToDefaultButton); 
                case NativeMethods.SPI_SETWHEELSCROLLLINES:
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.WheelScrollLines);
                case NativeMethods.SPI_SETMOUSEHOVERTIME:
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.MouseHoverTime); 
                case NativeMethods.SPI_SETMOUSEHOVERHEIGHT:
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.MouseHoverHeight); 
                case NativeMethods.SPI_SETMOUSEHOVERWIDTH: 
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.MouseHoverWidth);
                ...
                case NativeMethods.SPI_SETMENUFADE:
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.MenuFade);
                case NativeMethods.SPI_SETMENUSHOWDELAY:
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.MenuShowDelay); 

                case NativeMethods.SPI_SETCOMBOBOXANIMATION: 
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.ComboBoxAnimation); 
                case NativeMethods.SPI_SETCLIENTAREAANIMATION:
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.ClientAreaAnimation); 
                case NativeMethods.SPI_SETCURSORSHADOW:
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.CursorShadow);
                case NativeMethods.SPI_SETGRADIENTCAPTIONS:
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.GradientCaptions); 
                case NativeMethods.SPI_SETHOTTRACKING:
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.HotTracking); 
                case NativeMethods.SPI_SETLISTBOXSMOOTHSCROLLING: 
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.ListBoxSmoothScrolling);
                case NativeMethods.SPI_SETMENUANIMATION: 
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.MenuAnimation);
                case NativeMethods.SPI_SETSELECTIONFADE:
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.SelectionFade);
                case NativeMethods.SPI_SETSTYLUSHOTTRACKING: 
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.StylusHotTracking);
                case NativeMethods.SPI_SETTOOLTIPANIMATION: 
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.ToolTipAnimation); 
                case NativeMethods.SPI_SETTOOLTIPFADE:
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.ToolTipFade); 
                case NativeMethods.SPI_SETUIEFFECTS:
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.UIEffects);

                case NativeMethods.SPI_SETANIMATION: 
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.MinimizeAnimation);
                case NativeMethods.SPI_SETCARETWIDTH: 
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.CaretWidth); 
                case NativeMethods.SPI_SETFOREGROUNDFLASHCOUNT:
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.ForegroundFlashCount); 
                case NativeMethods.SPI_SETDRAGFULLWINDOWS:
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.DragFullWindows);
                ...
                case NativeMethods.SPI_SETDRAGWIDTH:
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.MinimumHorizontalDragDistance);
                case NativeMethods.SPI_SETDRAGHEIGHT: 
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.MinimumVerticalDragDistance);
                case NativeMethods.SPI_SETPENWINDOWS: 
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.IsPenWindows); 
                case NativeMethods.SPI_SETSHOWSOUNDS:
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.ShowSounds); 
                case NativeMethods.SPI_SETMOUSEBUTTONSWAP:
                    return SystemResources.ClearSlot(_cacheValid, (int)CacheSlot.SwapButtons);
            }
