...
namespace System.Windows.Automation.Peers 
{
    ...
    { 
        ...
        { 
            ...
            if (!IsGroupingEnabled() && VirtualizedItemPatternIdentifiers.Pattern != null && !(this is GridViewItemAutomationPeer) && !IsItemInAutomationTree())
        ...
        {
            ItemsControlAutomationPeer itemsControlAutomationPeer = ItemsControlAutomationPeer; 
            if(itemsControlAutomationPeer != null && (itemsControlAutomationPeer.Owner as ItemsControl).IsGrouping == true)
                return true;
            return false;
        } 
