    ...
    public abstract class SelectorAutomationPeer : ItemsControlAutomationPeer, ISelectionProvider
    {
        ...
        IRawElementProviderSimple [] ISelectionProvider.GetSelection()
        {
            ...
            { 
                ...
                { 
                    SelectorItemAutomationPeer peer = FindOrCreateItemAutomationPeer(owner._selectedItems[i]) as SelectorItemAutomationPeer;
                    if(peer != null) 
                    { 
        ...
        internal void RaiseSelectionEvents(SelectionChangedEventArgs e)
        {
            ...
            {
                SelectorItemAutomationPeer peer = FindOrCreateItemAutomationPeer(owner._selectedItems[0]) as SelectorItemAutomationPeer; 
                if(peer != null)
                { 
