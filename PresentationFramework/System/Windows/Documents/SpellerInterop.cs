...
namespace System.Windows.Documents 
{
    ...
    { 
        ...
        /// These 'trusted' files are placed under <paramref name="trustedLocations"/>.
        /// 
        ...
        ///
        /// Files specified in <paramref name="trustedLocations"/> are wrapped in FileIOPermission.Assert(), 
        ...
        private static class UnsafeNlMethods 
        {
            ...
            [DllImport(Microsoft.Internal.DllImport.PresentationNative, PreserveSig = false)] 
