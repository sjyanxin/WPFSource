...
{ 
    ...
    public sealed class KeyboardNavigation 
    {
        ...
        private List<WeakReference> _weakFocusChangedHandlers = new List<WeakReference>(1);
        #endregion 
        ...
        *        3   2
        ...
        internal event EnterMenuModeEventHandler EnterMenuMode 
        {
            ...
            add
            {
                ...
                if (_weakEnterMenuModeHandlers == null)
                    _weakEnterMenuModeHandlers = new List<WeakReference>(1); 
        ...
        private List<WeakReference> _weakEnterMenuModeHandlers; 
        ...
        private List<WeakReference> _weakFocusEnterMainFocusScopeHandlers = new List<WeakReference>(1); 
        #endregion
