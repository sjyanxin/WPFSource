        ...
        protected virtual void OnContentChanged(object oldContent, object newContent) 
        {
            ...
            { 
               ...
               { 
                   ...
                   // tree and the logical parent isn't an ancestor of this ContentControl,
                   // then we're moving the new content and we need to clean up the
                   // logical tree. 
                   var logicalParentFE = logicalParent as FrameworkElement;
                   if (logicalParentFE != null && !logicalParentFE.IsAncestorOf(this)) 
                   { 
                       logicalParentFE.RemoveLogicalChild(newContent);
                   } 
