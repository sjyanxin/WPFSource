        ...
        { 
            ...
            { 
                ...
                if (Depth == 0 || CurrentFrame.Type != null) 
                {
                    if (Depth > 0) 
                    {
                        isInNameScope = FrameworkTemplate.IsNameScope(CurrentFrame.Type) || CurrentFrame.IsInNameScope;
                    ...
                    try 
                    {
                        ...
                        { 
                            ...
                            { 
                                ...
                                case System.Xaml.XamlNodeType.Value:
                                    if (typeof(StaticResourceExtension).IsAssignableFrom(xamlReader.Value.GetType()))
                                    { 
                                        sharedValue = null;
                                        return false; 
                                    } 
