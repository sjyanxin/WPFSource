...
namespace MS.Internal.Data 
{
    ...
    { 
        ...
        /// <summary>
        /// Return true if <seealso cref="CurrentItem"/> is beyond the end or the collection is empty.
        /// </summary>
        ...
        /// <summary>
        /// Return true if <seealso cref="CurrentItem"/> is before the beginning or the collection is empty. 
        /// </summary> 
        ...
        /// <returns>true if <seealso cref="Current"/> points to an item within the view.</returns> 
        ...
        /// <summary>
        /// Move <seealso cref="Current"/> to the first item.
        /// </summary> 
        /// <returns>true if <seealso cref="Current"/> points to an item within the view.</returns>
        ...
        /// <summary> 
        /// Move <seealso cref="Current"/> to the last item.
        /// </summary> 
        /// <returns>true if <seealso cref="Current"/> points to an item within the view.</returns> 
        ...
        /// <summary>
        /// Move <seealso cref="Current"/> to the next item.
        /// </summary> 
        /// <returns>true if <seealso cref="Current"/> points to an item within the view.</returns>
        ...
        /// <summary> 
        /// Move <seealso cref="Current"/> to the previous item.
        /// </summary> 
        /// <returns>true if <seealso cref="Current"/> points to an item within the view.</returns> 
        ...
        /// this will simply raise a Reset event to <seealso cref="CollectionChanged"/> listeners.
        /// </remarks> 
        ...
        /// </summary> 
        private class FlatteningEnumerator : IEnumerator 
        {
            ...
            public object Current 
            {
                get 
                { 
                    // the spec for IEnumerator.Current says:
