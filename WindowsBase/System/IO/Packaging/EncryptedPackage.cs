...
namespace System.IO.Packaging
{
    ...
    public class EncryptedPackageEnvelope : IDisposable 
    {
        ...
        /// the compound file being created in <paramref name="fileName"/>.
        /// </param> 
        /// <param name="publishLicense">
        /// The publish license to be embedded in the compound file.
        /// </param>
        ...
        /// <param name="packageStream"> 
        /// A stream containing an unencrypted package which is to be stored in
        /// the compound file being created on <paramref name="encryptedPackageStream"/>. 
        /// </param>
        /// <param name="publishLicense">
        /// The publish license to be embedded in the compound file.
        /// </param> 
        ...
        /// If the file specified by <paramref name="path"/> does not exist.
        /// </exception>
        public static bool 
