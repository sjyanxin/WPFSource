...
{ 
    ...
    public sealed class Dispatcher
    {
        ...
        {
            return BeginInvokeImpl(priority, method, null, 0); 
        } 
        ...
        {
            return BeginInvokeImpl(priority, method, arg, 1); 
        } 
        ...
        {
            return BeginInvokeImpl(priority, method, CombineParameters(arg, args), -1); 
        }
        ...
        {
            return BeginInvokeImpl(DispatcherPriority.Normal, method, args, -1);
        } 
        ...
        { 
            return BeginInvokeImpl(priority, method, args, -1);
        }
        ...
        internal DispatcherOperation BeginInvokeImpl(DispatcherPriority priority, Delegate method, object args, int numArgs)
        {
            ...
            { 
                ...
                { 
                    EventTrace.EventProvider.TraceEvent(EventTrace.Event.WClientUIContextPost, EventTrace.Keyword.KeywordDispatcher | EventTrace.Keyword.KeywordPerf, EventTrace.Level.Info, priority, operation.Name);
                } 
            }
        ...
        {
            return InvokeImpl(priority, TimeSpan.FromMilliseconds(-1), method, null, 0); 
        } 
        ...
        { 
            return InvokeImpl(priority, TimeSpan.FromMilliseconds(-1), method, arg, 1);
        } 
        ...
        {
            return InvokeImpl(priority, TimeSpan.FromMilliseconds(-1), method, CombineParameters(arg, args), -1); 
        } 
        ...
        {
            return InvokeImpl(priority, timeout, method, null, 0);
        }
        ...
        {
            return InvokeImpl(priority, timeout, method, arg, 1); 
        }
        ...
        { 
            return InvokeImpl(priority, timeout, method, CombineParameters(arg, args), -1);
        } 
        ...
        {
            return InvokeImpl(DispatcherPriority.Normal, TimeSpan.FromMilliseconds(-1), method, args, -1);
        }
        ...
        {
            return InvokeImpl(priority, TimeSpan.FromMilliseconds(-1), method, args, -1); 
        }
        ...
        {
            return InvokeImpl(DispatcherPriority.Normal, timeout, method, args, -1); 
        } 
        ...
        { 
            return InvokeImpl(priority, timeout, method, args, -1); 
        }
        ...
        [SecurityCritical,SecurityTreatAsSafe]
        [FriendAccessAllowed] //used by DispatcherExtensionMethods in System.Windows.Presentation.dll 
        internal object InvokeImpl(DispatcherPriority priority, TimeSpan timeout, Delegate method, object args, int numArgs) 
        {
            ValidatePriority(priority, "priority"); 
            ...
            if(priority == DispatcherPriority.Send && CheckAccess()) // NOTE: should be Priority.Max 
            {
                ...
                bool setSynchronizationContext = oldSynchronizationContext != _dispatcherSynchronizationContext; 

                try 
                { 
                    if(setSynchronizationContext)
                    { 
                        SynchronizationContext.SetSynchronizationContext(_dispatcherSynchronizationContext);
                    }

                    result = WrappedInvoke(method, args, numArgs); 
                }
                finally 
                { 
                    if(setSynchronizationContext)
            ...
            { 
                DispatcherOperation op = BeginInvokeImpl(priority, method, args, numArgs); 
                if(op != null)
                { 
                    op.Wait(timeout);
...
*/ 
        ...
        internal object WrappedInvoke(Delegate callback, object args, int numArgs) 
        { 
            return WrappedInvoke(callback, args, numArgs, null);
        } 
        ...
        internal DispatcherSynchronizationContext _dispatcherSynchronizationContext;
