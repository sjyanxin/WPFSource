...
#pragma warning disable 1634, 1691 
    ...
    { 
        ...
        { 
            ...
            System.Drawing.Bitmap bitmapData; 
            ...
            if (data is BitmapSource)
            {
                ...
                bitmapEncoder.Frames.Add(BitmapFrame.Create(data as BitmapSource)); 

                bitmapStream = new MemoryStream();
                bitmapEncoder.Save(bitmapStream);
 
                bitmapData = new System.Drawing.Bitmap(bitmapStream);
            } 
            else 
            {
                // Get Bitmap data from data object. 
                bitmapData = data as System.Drawing.Bitmap;
            }
            ...
            { 
                ...
                hBitmapNew = Win32CreateCompatibleBitmap(new HandleRef(this, hDC), bitmapData.Size.Width, bitmapData.Size.Height);
                ...
                try 
                {
                    ...
                    Win32BitBlt(new HandleRef(this, destinationDC), bitmapData.Size.Width, bitmapData.Size.Height, new HandleRef(null, sourceDC), /* SRCCOPY */0x00CC0020);
                }
                finally 
                {
        ...
        private IntPtr GetEnhancedMetafileHandle(String format, object data) 
        {
            ...
            if (IsFormatEqual(format, DataFormats.EnhancedMetafile))
            {
                ...
                if (AssemblyHelper.IsMetafile(data)) 
                {
                    hEnhancedMetafile = AssemblyHelper.GetHandleFromMetafile(data); 
                } 
        ...
        private int GetDataIntoOleStructsByTypeMedimHGlobal(string format, object data, ref STGMEDIUM medium, bool doNotReallocate) 
        {
            ...
            else if (IsFormatEqual(format, typeof(System.Drawing.Bitmap).FullName)) 
            { 
                ...
                || AssemblyHelper.IsMetafile(data))
            { 
        ...
        private int GetDataIntoOleStructsByTypeMediumGDI(string format, object data, ref STGMEDIUM medium) 
        {
            ...
            if (IsFormatEqual(format, DataFormats.Bitmap) 
                && (AssemblyHelper.IsBitmap(data) || IsDataSystemBitmapSource(data)))
            { 
        ...
        { 
            ...
            else if (AssemblyHelper.IsBitmap(data)) 
            {
                System.Drawing.Bitmap systemDrawingBitmap;

                systemDrawingBitmap = (System.Drawing.Bitmap)data; 

                // Create BitmapSource instance from System.Drawing.Bitmap 
                bitmapSource = Imaging.CreateBitmapSourceFromHBitmap( 
                    systemDrawingBitmap.GetHbitmap(),
                    IntPtr.Zero, 
                    Int32Rect.Empty,
                    null);
            }
        ...
        { 
            ...
            systemDrawingBitmap = null; 

            if (AssemblyHelper.IsBitmap(data))
            {
                systemDrawingBitmap = (System.Drawing.Bitmap)data; 
            }
            else if (IsDataSystemBitmapSource(data)) 
            { 
                Stream bitmapStream;
                BitmapEncoder bitmapEncoder; 
                ...
                // Create System.Drawing.Bitmap instance from the bitmap stream of BitmapSource 
                systemDrawingBitmap = new System.Drawing.Bitmap(bitmapStream);
            } 
...
#pragma warning restore 6523 
        ...
        private static object EnsureBitmapDataFromFormat(string format, bool autoConvert, object data)
        {
            ...
            { 
                ...
                if (autoConvert) 
                {
                    ...
                    bitmapEncoder = new BmpBitmapEncoder();
                    bitmapEncoder.Frames.Add(BitmapFrame.Create((BitmapSource)data)); 
                    bitmapStream = new MemoryStream();
                    bitmapEncoder.Save(bitmapStream);
                     ...
                     (IsFormatEqual(format, DataFormats.Bitmap) || IsFormatEqual(format, SystemBitmapSourceFormat))) 
            {
                ...
                if (autoConvert) 
                {
                    // Convert data from SystemDrawingBitmap to SystemBitmapSource 
                    System.Drawing.Bitmap systemDrawingBitmap;
                    systemDrawingBitmap = (System.Drawing.Bitmap)data;
                    ...
                    if (mappedFormats != null) 
                    {
                        ...
                        { 
                            ...
                            { 
                                ...
                                { 
                                    if (IsDataSystemBitmapSource(baseVar) || AssemblyHelper.IsBitmap(baseVar))
                                    { 
                    ...
                    { 
                        ...
                        if (medium.unionmember != IntPtr.Zero) 
                        {
                            ...
                            { 
                                ...
                                data = AssemblyHelper.GetMetafileFromHemf(medium.unionmember);
                            }
                        } 
                    }
                    finally 
        ...
        { 
            ...
            { 
                ...
                {
                    if (autoConvert && (AssemblyHelper.IsBitmap(data) || IsDataSystemBitmapSource(data))) 
                    {
