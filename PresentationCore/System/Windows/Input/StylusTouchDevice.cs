...
{ 
    ...
    internal sealed class StylusTouchDevice : TouchDevice 
    {
        ...
        /// </SecurityNote> 
        internal IList<StagingAreaInputItem> StoredStagingAreaItems
        { 
            [SecurityCritical]
            get
            {
                if (_storedStagingAreaItems == null) 
                {
                    _storedStagingAreaItems = new List<StagingAreaInputItem>(); 
                } 
        ...
        /// </SecurityNote>
        [SecurityCritical]
        private List<StagingAreaInputItem> _storedStagingAreaItems; 
