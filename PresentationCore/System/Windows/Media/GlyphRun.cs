...
#pragma warning suppress 56506
        ...
        public Rect ComputeInkBoundingBox()
        {
            ...
            ushort[] glyphIndices = BufferCache.GetUShorts(_glyphIndices.Count);
            _glyphIndices.CopyTo(glyphIndices, 0); 
 
            MS.Internal.Text.TextInterface.GlyphMetrics[] glyphMetrics = BufferCache.GetGlyphMetrics(_glyphIndices.Count);
